...
class my_sparse_mm(torch.autograd.Function):
    ...
    Реализация новой autograd функции для разреженных переменных,
    создается подкласс функции torch.autograd.Function и объявляются
...
class Graph_ConvNet_LeNet5(nn.Module):
    ...
    def graph_conv_cheby(self, x, cl, L, lmax, Fout, K):
        ...
        # Сводим к полиному чебышева (https://dic.academic.ru/dic.nsf/ruwiki/1099923?ysclid=l5taavhpek223877434)
